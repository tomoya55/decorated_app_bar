...
///  * See our
///    [DecoratedAppBar Basics sample](https://flutter.dev/docs/catalog/samples/basic-app-bar)
...
class _FloatingDecoratedAppBar extends StatefulWidget {
  const _FloatingDecoratedAppBar({Key key, this.child}) : super(key: key);
...
class SliverDecoratedAppBar extends StatefulWidget {
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [DecoratedAppBar] will
  /// imply an appropriate widget. For example, if the [DecoratedAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [DecoratedAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// be the same as the app bar's overall height.
  ///
  /// When using [SliverDecoratedAppBar.flexibleSpace], the [SliverDecoratedAppBar.expandedHeight]
  /// must be large enough to accommodate the [SliverDecoratedAppBar.flexibleSpace] widget.
  ///
  /// Typically a [FlexibleSpaceBar]. See [FlexibleSpaceBar] for details.
  final Widget flexibleSpace;
