...
void main() {
    ...
    await tester.pumpWidget(Localizations(
      ...
      child: Directionality(
        ...
        child: MediaQuery(
          ...
          child: Scaffold(
            primary: true,
            appBar: DecoratedAppBar(title: const Text('title')),
          ),
        ),
      ),
    ));
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          drawer: const Drawer(),
          appBar: DecoratedAppBar(automaticallyImplyLeading: false),
        ),
      ),
    );
    expect(find.byIcon(Icons.menu), findsNothing);
  ...
  testWidgets('DecoratedAppBar draws a light system bar for a dark background',
    ...
    await tester.pumpWidget(MaterialApp(
      theme: darkTheme,
      home: Scaffold(
        appBar: DecoratedAppBar(title: const Text('test')),
      ),
    ));
  ...
  testWidgets('DecoratedAppBar shape default', (WidgetTester tester) async {
    ...
    final Finder appBarFinder = find.byType(DecoratedAppBar);
    DecoratedAppBar getDecoratedAppBarWidget(Finder finder) =>
        tester.widget<DecoratedAppBar>(finder);
    expect(getDecoratedAppBarWidget(appBarFinder).shape, null);
  ...
  testWidgets('DecoratedAppBar with shape', (WidgetTester tester) async {
    ...
    DecoratedAppBar getDecoratedAppBarWidget(Finder finder) =>
        tester.widget<DecoratedAppBar>(finder);
    expect(
        getDecoratedAppBarWidget(appBarFinder).shape, roundedRectangleBorder);
